...
typedef struct
{
	...
	lv_obj_t *screen;
	bool screen_del;
	lv_obj_t *screen_slider_x_pix;
	lv_obj_t *screen_cont_mode_control;
	lv_obj_t *screen_label_1;
	lv_obj_t *screen_btn_hand_set;
	lv_obj_t *screen_btn_hand_set_label;
	lv_obj_t *screen_btn_demo_linear;
	lv_obj_t *screen_btn_demo_linear_label;
	lv_obj_t *screen_btn_demo_nonlinear;
	lv_obj_t *screen_btn_demo_nonlinear_label;
	lv_obj_t *screen_cont_1;
	lv_obj_t *screen_ddlist_nonlinear;
	lv_obj_t *screen_label_2;
	lv_obj_t *screen_btn_select;
	lv_obj_t *screen_btn_select_label;
	lv_obj_t *screen_label_x_pix_;
	lv_obj_t *screen_label_y_pix_len_;
	lv_obj_t *screen_label_y_pix;
	lv_obj_t *screen_label_x_pix;
	lv_obj_t *screen_img_1;
	lv_obj_t *screen_ddlist_min;
	lv_obj_t *screen_ddlist_max;
	lv_obj_t *screen_label_3;
	lv_obj_t *screen_label_4;
	lv_obj_t *screen_slider_y_pix;
	lv_obj_t *screen_btnm_x_pic;
	lv_obj_t *screen_btnm_y_pic;
	lv_obj_t *screen_label_vid_format;
	lv_obj_t *screen_label_6;
	lv_obj_t *screen_ddlist_vid_format;
	lv_obj_t *screen_ddlist_algorithm;
	lv_obj_t *screen_Alpha_cont;
	lv_obj_t *screen_slider_a;
	lv_obj_t *screen_label_a;
	lv_obj_t *screen_label_a_value;
...
LV_IMG_DECLARE(_cbf040c3eda1f28470a3ec0f5384e18e1334bea0_alpha_242x106);
