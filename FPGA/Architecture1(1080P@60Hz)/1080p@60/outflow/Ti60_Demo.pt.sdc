...
# PLL Constraints
#################
create_clock -period 1.9685 tdqss_clk
create_clock -period 3.9370 core_clk
create_clock -period 1.9685 tac_clk
create_clock -waveform {0.4921 1.4764} -period 1.9685 twd_clk
create_clock -period 41.6667 ddr_pll_CLKOUT4
create_clock -period 40.0000 clk_sys
create_clock -period 6.6667 clk_pixel_2x
create_clock -period 6.6667 clk_pixel
create_clock -waveform {0.3333 1.0000} -period 1.3333 clk_pixel_10x
create_clock -period 10.4167 clk_96m
create_clock -period 166.6667 clk_6m
create_clock -period 13.3929 clk_75m
create_clock -period 10.4167 clk_100m
...
# set_clock_latency -source -setup <board_max + 1.907> [get_ports {clk_6m}]
# set_clock_latency -source -hold <board_min + 1.271> [get_ports {clk_6m}]
