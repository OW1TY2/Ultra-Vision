...
module edb_top (
    ...
    output bscan_TDO,
    input  la0_clk,
    input  [26:0] la0_probe0,
    input  [26:0] la0_probe1,
    input  [7:0] la0_probe2,
    input  la0_probe3,
    input  [16:0] la0_probe4,
    input  [17:0] la0_probe5,
    input  [37:0] la0_probe6,
    input  [39:0] la0_probe7,
    input  [27:0] la0_probe8,
    input  [9:0] la0_probe9,
    input  [39:0] la0_probe10,
    input  [19:0] la0_probe11,
    input  [9:0] la0_probe12,
    input  [9:0] la0_probe13,
    input  [9:0] la0_probe14,
    input  [19:0] la0_probe15,
    input  [9:0] la0_probe16,
    input  [9:0] la0_probe17,
    input  [39:0] la0_probe18,
    input  [19:0] la0_probe19
);
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'h383d72b14cb8455f9f4573059d5755fe ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 27 ),
        .PROBE0_TYPE        ( 2 ),
        .PROBE1_WIDTH       ( 27 ),
